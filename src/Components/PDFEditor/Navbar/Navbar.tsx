...
export function Navbar() {
    ...
    return (
        <div className="sticky top-0 flex justify-center">
            <nav className="flex justify-center gap-2 p-3 my-4 rounded-xs bg-white border-2 border-rose-500">
                ...
                <div className="flex items-center">
                    ...
                    <p className="font-bold rounded-xl text-rose-400 mx-2 text-lg" title="Zoom Level">{Math.floor(zoomLevel * 100)}%</p>
                ...
                <NavbarButton title={"Add PDF"}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
                    </svg>
                    <label htmlFor="addFile" className="absolute w-full h-full top-0 left-0 cursor-pointer"></label>
                    <input id="addFile" type="file" onChange={handleAddPage} title="Add PDF" className="hidden"/>
                </NavbarButton>
            </nav>
        </div>
    )
