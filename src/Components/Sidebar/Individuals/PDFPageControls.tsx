    ...
    return (
        <div className="relative">
            <div className="flex justify-center mt-1 mb-2">
                ...
                {pageNum > 1 &&
                    <SidebarButton onclick={() => setToggleDelete(true)} title={"Delete Page"}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#fff" viewBox="0 0 16 16">
            ...
            {toggleDelete && <DeletePageModal removePage={() => {removePage(index); setToggleDelete(false)}} setToggleDelete={() => setToggleDelete(false)}/>}
        </div>
    )
};