...
export function Sidebar() {
    ...
    return (
        <div>
            <div className="sticky top-4 flex flex-col items-center max-h-[85vh] h-fit z-20 mx-4 p-4 border-4 border-cyan-500 bg-white rounded-xl overflow-y-auto" id="sidebarContainer">
